...
function Table({
  ...
  return (
    <table
      ...
      className={cn(
        "w-full border-collapse text-right text-lg",
        "[&_thead_th]:bg-slide-primary [&_thead_th]:p-4 [&_thead_th]:text-right [&_thead_th]:text-base [&_thead_th]:font-bold [&_thead_th]:text-slide-primary-fg",
        "[&_tbody_td]:border-b [&_tbody_td]:border-slide-border [&_tbody_td]:px-5.5 [&_tbody_td]:py-4.5 [&_tbody_td]:text-slide-fg-muted",
