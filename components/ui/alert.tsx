  ...
  "group/alert relative grid w-full gap-0.5 rounded-2xl border px-4 py-3 text-start text-sm has-data-[slot=alert-action]:relative has-data-[slot=alert-action]:pe-18 has-[>svg]:grid-cols-[auto_1fr] has-[>svg]:gap-x-2.5 *:[svg]:row-span-2 *:[svg]:translate-y-0.5 *:[svg]:text-current *:[svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        accent:
          "rounded-slide border-r-[5px] border-slide-accent-soft border-r-slide-accent bg-slide-accent-soft p-[14px_22px] text-[1.05rem] text-slide-accent",
        info: "rounded-slide border-r-[5px] border-slide-primary-soft border-r-slide-primary bg-slide-primary-tint p-[14px_22px] text-[1.05rem] text-slide-primary",
      },
    },
    defaultVariants: {
      variant: "default",
