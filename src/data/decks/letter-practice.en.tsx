/**
 * Deck: letter-practice (English)
 * Chapter 2 · Lesson 1 — "Distinguishing Haa (ح) and Khaa (خ)"
 *
 * Pronunciation exercises distinguishing ح (haa) from خ (khaa),
 * using meaningful words and practice syllables.
 *
 * Quranic Arabic / practice words remain in Arabic script — they are
 * practice text, not translatable. Only the surrounding UI is translated
 * to English.
 */
  ...
  return (
    <>
      ...
      <div className="cover__main">
        <CoverTitle>Distinguishing Haa (ح) and Khaa (خ)</CoverTitle>
        <CoverRule />
        <CoverSubtitle>
          Meaningful words and practice exercises to distinguish close
          articulation points
        </CoverSubtitle>
        <CoverMeta>
          <CoverChip color="haa">Haa (ح)</CoverChip>
          <CoverChip color="khaa">Khaa (خ)</CoverChip>
        </CoverMeta>
      </div>
    </>
  )
...
function SlideDivider() {
  return (
    <DividerSlide
      ...
      desc="Meaningful words and practice words to distinguish Haa and Khaa."
    />
  )
}
...
function SlideWordsMeaning() {
  return (
    <SlideShell eyebrow="Exercises · 1" title="Meaningful Words">
      <p className="m-0 mb-2 text-center text-base text-slide-fg-muted">
        Familiar words to reinforce letter pronunciation in natural context.
      </p>
      <CardWords>
      ...
      <DisplayLegendRow>
        <DisplayLegendChip color="haa">Haa (ح)</DisplayLegendChip>
        <DisplayLegendChip color="khaa">Khaa (خ)</DisplayLegendChip>
      </DisplayLegendRow>
    </SlideShell>
  )
}
...
function SlideWordsPractice() {
  return (
    <SlideShell eyebrow="Exercises · 2" title="Practice Words">
      <p className="m-0 mb-2 text-center text-base text-slide-fg-muted">
        Non-meaningful syllables to focus attention on distinguishing close
        articulation points.
      </p>
      <CardWords>
...
export const LETTER_PRACTICE_SLIDES_EN: readonly SlideDefinition[] = [
